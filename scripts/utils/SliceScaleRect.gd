# from user 25GreenBeans in this Godot forum thread: https://forum.godotengine.org/t/is-there-any-way-to-scale-up-a-ninepatchrect-without-actually-scaling-the-node/63237

@tool
class_name SliceScaleRect
extends Container
